...
import com.goldthorp.ching.view.MainActivity;
...
public class BackupUtil {
  ...
  private List<List<Object>> deserialize(
    ...
    final Iterable<Class> classes = getBackupEntityTypes();
  ...
  /**
   * Find all classes in `com.goldthorp.ching.model` annotated with @BackupEntity.
   *
   * @return all classes that can be backed up
   */
  private Iterable<Class> getBackupEntityTypes() {
    ...
    try {
      ...
      while (iter.hasMoreElements()) {
        ...
        if (className.contains("com.goldthorp.ching.model")) {
